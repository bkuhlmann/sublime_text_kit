...
RSpec.describe SublimeTextKit::CLI do
  describe ".start" do
    ...
    let :cli do
      lambda do
        load "sublime_text_kit/cli.rb" # Ensures clean Thor `.method_option` evaluation per spec.
    ...
    shared_examples_for "a version command" do
      it "prints version" do
        pattern = /#{SublimeTextKit::Identity.label}\s#{SublimeTextKit::Identity.version}\n/
